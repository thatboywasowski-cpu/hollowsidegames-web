document.addEventListener("DOMContentLoaded", function () {
    ...
    function avatarMarkup(card) {
        if (card.avatar_url) {
            return '<span class="account-avatar-preview"><img src="' + escapeHtml(card.avatar_url) + '" alt="Profile picture"></span>';
        }
                ...
                '<article class="account-card">' +
                    '<div class="profile-mini-card">' +
                        ...
                        '<div class="profile-mini-copy">' +
                            ...
                            '<p>' + escapeHtml(card.role_label) + " · Member since " + escapeHtml(new Date(card.member_since).toLocaleDateString()) + '</p>' +
                        '</div>' +
                    '</div>' +
                    '<p class="account-note">' + escapeHtml(card.bio || "No bio yet.") + '</p>' +
                    '<div class="profile-stats">' +
                        '<div class="profile-stat"><strong>' + card.follower_count + '</strong><span>Followers</span></div>' +
                        '<div class="profile-stat"><strong>' + card.following_count + '</strong><span>Following</span></div>' +
                        '<div class="profile-stat"><strong>' + card.friend_count + '</strong><span>Friends</span></div>' +
                    '</div>' +
